...
!
daemon TerminAttr
   exec /usr/bin/TerminAttr -cvaddr=apiserver.cv-prod-us-central1-c.arista.io:443 -cvauth=token-secure,/tmp/cv-onboarding-token -cvvrf=MGMT -disableaaa -smashexcludes=ale,flexCounter,hardware,kni,pulse,strata -taillogs -sflowaddr=default/127.0.0.1:6343 -cvsourceintf=Management1
   no shutdown
```
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.101.255.0 | Port-Channel511 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_dc1-host2_Ethernet2 | *access | *200 | *- | *- | 1 |
| Ethernet51/1 | MLAG_dc1-leaf3_Ethernet51/1 | *trunk | *- | *- | *MLAG | 511 |
| Ethernet52/1 | MLAG_dc1-leaf3_Ethernet52/1 | *trunk | *- | *- | *MLAG | 511 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_dc1-spine1_Ethernet1/4 | - | 10.101.0.13/31 | default | 9214 | False | - | - |
| Ethernet50/1 | P2P_dc1-spine2_Ethernet1/4 | - | 10.101.0.15/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description SERVER_dc1-host2_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description P2P_dc1-spine1_Ethernet1/4
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet50/1
   description P2P_dc1-spine2_Ethernet1/4
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet51/1
   description MLAG_dc1-leaf3_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_dc1-leaf3_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SERVER_dc1-host2 | access | 200 | - | - | - | - | 1 | - |
| Port-Channel511 | MLAG_dc1-leaf3_Port-Channel511 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel511
   description MLAG_dc1-leaf3_Port-Channel511
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.99.1.4/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.101.1.3/32 |
...
| Vlan3500 | MLAG_L3_VRF_BLUE | BLUE | 9214 | False |
| Vlan3501 | MLAG_L3_VRF_GREEN | GREEN | 9214 | False |
| Vlan3502 | MLAG_L3_VRF_RED | RED | 9214 | False |
...
| 10.101.0.12 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
| 10.101.0.14 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
...
| 10.101.254.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.99.1.4:10100 | 10100:10100 | - | - | learned |
| 200 | 10.99.1.4:10200 | 10200:10200 | - | - | learned |
| 300 | 10.99.1.4:10300 | 10300:10300 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| BLUE | 10.99.1.4:501 | connected | - |
| GREEN | 10.99.1.4:502 | connected | - |
| RED | 10.99.1.4:503 | connected | - |
...
router bgp 65102
   ...
   neighbor 10.101.0.12 remote-as 65000
   neighbor 10.101.0.12 bfd
   neighbor 10.101.0.12 description dc1-spine1_Ethernet1/4
   neighbor 10.101.0.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.14 remote-as 65000
   neighbor 10.101.0.14 bfd
   neighbor 10.101.0.14 description dc1-spine2_Ethernet1/4
   neighbor 10.101.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.101.254.0 description dc1-leaf3_Vlan4093
   ...
   vrf BLUE
      ...
      update wait-install
      neighbor 10.101.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.0 description dc1-leaf3_Vlan3500
   ...
   vrf GREEN
      ...
      update wait-install
      neighbor 10.101.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.0 description dc1-leaf3_Vlan3501
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf RED
      rd 10.99.1.4:503
      ...
      update wait-install
      neighbor 10.101.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.0 description dc1-leaf3_Vlan3502
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
