...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.101.255.0 | Port-Channel511 |
...
| Ethernet51/1 | MLAG_dc1-leaf1_Ethernet51/1 | *trunk | *- | *- | *MLAG | 511 |
| Ethernet52/1 | MLAG_dc1-leaf1_Ethernet52/1 | *trunk | *- | *- | *MLAG | 511 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_dc1-spine1_Ethernet1/2 | - | 10.101.0.5/31 | default | 9214 | False | - | - |
| Ethernet50/1 | P2P_dc1-spine2_Ethernet1/2 | - | 10.101.0.7/31 | default | 9214 | False | - | - |
...
interface Ethernet51/1
   description MLAG_dc1-leaf1_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_dc1-leaf1_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| Port-Channel511 | MLAG_dc1-leaf1_Port-Channel511 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel511
   description MLAG_dc1-leaf1_Port-Channel511
   no shutdown
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.99.1.2:10100 | 10100:10100 | - | - | learned |
| 200 | 10.99.1.2:10200 | 10200:10200 | - | - | learned |
| 300 | 10.99.1.2:10300 | 10300:10300 | - | - | learned |
...
router bgp 65101
   ...
   neighbor 10.101.254.0 description dc1-leaf1_Vlan4093
   ...
   vrf BLUE
      ...
      update wait-install
      neighbor 10.101.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.0 description dc1-leaf1_Vlan3500
   ...
   vrf GREEN
      ...
      update wait-install
      neighbor 10.101.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.0 description dc1-leaf1_Vlan3501
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf RED
      rd 10.99.1.2:503
      ...
      update wait-install
      neighbor 10.101.254.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.0 description dc1-leaf1_Vlan3502
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
