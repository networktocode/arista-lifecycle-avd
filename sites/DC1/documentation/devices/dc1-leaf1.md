...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.101.255.1 | Port-Channel511 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_dc1-host1_Ethernet1 | *access | *100 | *- | *- | 1 |
| Ethernet51/1 | MLAG_dc1-leaf2_Ethernet51/1 | *trunk | *- | *- | *MLAG | 511 |
| Ethernet52/1 | MLAG_dc1-leaf2_Ethernet52/1 | *trunk | *- | *- | *MLAG | 511 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_dc1-spine1_Ethernet1/1 | - | 10.101.0.1/31 | default | 9214 | False | - | - |
| Ethernet50/1 | P2P_dc1-spine2_Ethernet1/1 | - | 10.101.0.3/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description SERVER_dc1-host1_Ethernet1
   no shutdown
...
interface Ethernet51/1
   description MLAG_dc1-leaf2_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_dc1-leaf2_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| Port-Channel511 | MLAG_dc1-leaf2_Port-Channel511 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel511
   description MLAG_dc1-leaf2_Port-Channel511
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.99.1.1/32 |
...
| 10.101.0.0 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
| 10.101.0.2 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.99.1.1:10100 | 10100:10100 | - | - | learned |
| 200 | 10.99.1.1:10200 | 10200:10200 | - | - | learned |
| 300 | 10.99.1.1:10300 | 10300:10300 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| BLUE | 10.99.1.1:501 | connected | - |
| GREEN | 10.99.1.1:502 | connected | - |
| RED | 10.99.1.1:503 | connected | - |
...
router bgp 65101
   ...
   neighbor 10.101.0.0 remote-as 65000
   neighbor 10.101.0.0 bfd
   neighbor 10.101.0.0 description dc1-spine1_Ethernet1/1
   neighbor 10.101.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.2 remote-as 65000
   neighbor 10.101.0.2 bfd
   neighbor 10.101.0.2 description dc1-spine2_Ethernet1/1
   neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.101.254.1 description dc1-leaf2_Vlan4093
   ...
   vrf BLUE
      ...
      update wait-install
      neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.1 description dc1-leaf2_Vlan3500
   ...
   vrf GREEN
      ...
      update wait-install
      neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.1 description dc1-leaf2_Vlan3501
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf RED
      rd 10.99.1.1:503
      ...
      update wait-install
      neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.1 description dc1-leaf2_Vlan3502
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
