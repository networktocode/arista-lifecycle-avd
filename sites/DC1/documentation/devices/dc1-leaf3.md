...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.101.255.1 | Port-Channel511 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_dc1-host2_Ethernet1 | *access | *200 | *- | *- | 1 |
| Ethernet51/1 | MLAG_dc1-leaf4_Ethernet51/1 | *trunk | *- | *- | *MLAG | 511 |
| Ethernet52/1 | MLAG_dc1-leaf4_Ethernet52/1 | *trunk | *- | *- | *MLAG | 511 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_dc1-spine1_Ethernet1/3 | - | 10.101.0.9/31 | default | 9214 | False | - | - |
| Ethernet50/1 | P2P_dc1-spine2_Ethernet1/3 | - | 10.101.0.11/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description SERVER_dc1-host2_Ethernet1
   no shutdown
...
interface Ethernet50/1
   description P2P_dc1-spine2_Ethernet1/3
   no shutdown
   mtu 9214
   no switchport
...
interface Ethernet51/1
   description MLAG_dc1-leaf4_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_dc1-leaf4_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| Port-Channel511 | MLAG_dc1-leaf4_Port-Channel511 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel511
   description MLAG_dc1-leaf4_Port-Channel511
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.99.1.3/32 |
...
| 10.101.0.8 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
| 10.101.0.10 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
...
router bgp 65102
   ...
   neighbor 10.101.0.8 remote-as 65000
   neighbor 10.101.0.8 bfd
   neighbor 10.101.0.8 description dc1-spine1_Ethernet1/3
   neighbor 10.101.0.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.10 remote-as 65000
   neighbor 10.101.0.10 bfd
   neighbor 10.101.0.10 description dc1-spine2_Ethernet1/3
   neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.101.254.1 description dc1-leaf4_Vlan4093
   ...
   vrf BLUE
      ...
      update wait-install
      neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.1 description dc1-leaf4_Vlan3500
