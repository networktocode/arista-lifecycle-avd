...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_dc1-leaf1_Ethernet50/1 | - | 10.101.0.2/31 | default | 1500 | False | - | - |
| Ethernet1/2 | P2P_dc1-leaf2_Ethernet50/1 | - | 10.101.0.6/31 | default | 1500 | False | - | - |
| Ethernet1/3 | P2P_dc1-leaf3_Ethernet50/1 | - | 10.101.0.10/31 | default | 1500 | False | - | - |
| Ethernet1/4 | P2P_dc1-leaf4_Ethernet50/1 | - | 10.101.0.14/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.99.1.130/32 |
...
| 10.101.0.3 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
| 10.101.0.7 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
| 10.101.0.11 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
| 10.101.0.15 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 10.101.0.3 remote-as 65101
   neighbor 10.101.0.3 bfd
   neighbor 10.101.0.3 description dc1-leaf1_Ethernet50/1
   neighbor 10.101.0.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.7 remote-as 65101
   neighbor 10.101.0.7 bfd
   neighbor 10.101.0.7 description dc1-leaf2_Ethernet50/1
   neighbor 10.101.0.11 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.11 remote-as 65102
   neighbor 10.101.0.11 bfd
   neighbor 10.101.0.11 description dc1-leaf3_Ethernet50/1
   neighbor 10.101.0.15 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.15 remote-as 65102
   neighbor 10.101.0.15 bfd
   neighbor 10.101.0.15 description dc1-leaf4_Ethernet50/1
